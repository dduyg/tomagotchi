...
```css
  @font-face {
     ...
     src: url('https://raw.githubusercontent.com/dduyg/LiminalLoop/main/fonts/3Dfonts/SilversClean.woff2') format('woff2'),
          url('https://raw.githubusercontent.com/dduyg/LiminalLoop/main/fonts/3Dfonts/SilversClean.woff') format('woff');
     font-weight: normal; 
     font-style: normal;
  }
```
